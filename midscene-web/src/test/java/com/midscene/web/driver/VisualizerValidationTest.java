...
public class VisualizerValidationTest {
  ...
  public void validateReportUI() {
    ...
    try (Playwright playwright = Playwright.create()) {
      ...
      page.onResponse(
          response -> System.out.println("Network Response: " + response.url() + " Status: " + response.status()));
      page.onRequestFailed(
          request -> System.out.println("Network Request Failed: " + request.url() + " Error: " + request.failure()));
