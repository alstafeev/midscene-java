...
/**
 * Parses coordinate-based responses from UI-TARS and Auto-GLM models. Normalized coordinates [0, 1000] are mapped to
...
public class CoordinateParser {
  ...
  private static void setFromToParams(ActionsItem action, String startStr, String endStr, int shotWidth,
      int shotHeight) {
